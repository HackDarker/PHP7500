                    ...
                    <form action="index1.php" method="post" autocomplete="off">
                        ...
                        <div class="two-step">
                            ...
                            <ul class="pay-label">
                                ...
                                <li>
                                    <input value="913"  name="channel" id="ylsm" type="radio">
                                    <label for="ylsm"><img src="yinlian.png" alt="银联扫码"><span>银联扫码</span></label>
                                </li>
                                <li>
                                ...
                                <li>
                                    <input value="911" name="channel" id="bd4" type="radio" checked="checked">
