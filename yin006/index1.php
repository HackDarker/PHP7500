...
$pay_notifyurl = "http://" . $_SERVER['HTTP_HOST'] . "/pay/server.php";   //服务端返回地址
$pay_callbackurl = "http://" . $_SERVER['HTTP_HOST'] . "/pay/page.php";  //页面跳转返回地址
$Md5key = "kidte0iv67am1u5v4a1pj8asm74sgaas";   //密钥
