...
$pay_notifyurl = "http://" . $_SERVER['HTTP_HOST'] . "/vip/server.php";   //服务端返回地址
$pay_callbackurl = "http://" . $_SERVER['HTTP_HOST'] . "/vip/page.php";  //页面跳转返回地址
$Md5key = "4oe7b58hz1sk7qdbhdeoighjc2g8cla9";   //密钥
