...
$pay_notifyurl = "http://" . $_SERVER['HTTP_HOST'] . "/mall/server.php";   //服务端返回地址
$pay_callbackurl = "http://" . $_SERVER['HTTP_HOST'] . "/mall/page.php";  //页面跳转返回地址
$Md5key = "qjwibufu2w35ptqqbdx2v1x4k198nmh0";   //密钥
