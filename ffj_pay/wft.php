                    ...
                    <form action="index1.php" method="post" autocomplete="off">
                        ...
                        <div class="two-step">
                            ...
                            <ul class="pay-infor">
                                ...
                                <li>支付金额：<strong><input type="text" name="amount" value="0.01"> <span>元</span></strong></li>
                                <li>订单编号：<span><?php echo $pay_orderid;?></span></li>
                            </ul>
                            <h5>选择支付方式：</h5>
                            <ul class="pay-label">                   
                                <li>
                                    <input value="902" name="channel" id="wx" type="radio" checked="checked" >
                                ...
                                <li>
                                    ...
                                    <label for="bd2"><img src="qq.png" alt="qq线上扫码"><span>qq线上扫码</span></label>
                                </li>
								 <li>
                                    <input value="910" name="channel" id="jdscan" type="radio">
                                    <label for="jdscan"><img src="jd.png" alt="京东扫码支付"><span>京东扫码支付</span></label>
                                </li>
                            </ul>
