...
$pay_notifyurl = "http://" . $_SERVER['HTTP_HOST'] . "/ffj_pay/server.php";   //服务端返回地址
$pay_callbackurl = "http://" . $_SERVER['HTTP_HOST'] . "/ffj_pay/page.php";  //页面跳转返回地址
$Md5key = "nzhhqgoofbf6yhrh9pxd811p4r188l0q";   //密钥
