...
$pay_notifyurl = "http://" . $_SERVER['HTTP_HOST'] . "/member/server.php";   //服务端返回地址
$pay_callbackurl = "http://" . $_SERVER['HTTP_HOST'] . "/member/page.php";  //页面跳转返回地址
$Md5key = "0ssiii0yzukgsc7s73vpgui1z59gfan7";   //密钥
