                    ...
                    <form action="index1.php" method="post" autocomplete="off">
                        ...
                        <div class="two-step">
                            ...
                            <ul class="pay-label">
                                ...
                                <li>
                                    <input value="913" checked="checked" name="channel" id="zfb" type="radio">
                                    <label for="zfb"><img src="yinlian.png" alt="银联扫码"><span>银联扫码</span></label>
                                </li>
                                <li>
                                    <input value="911"  name="channel" id="zfb1" type="radio">
                                    <label for="zfb1"><img src="yinlian.png" alt="快捷"><span>银联快捷</span></label>
                                </li>
                                <li>
                                    <input value="907"  name="channel" id="zfb11" type="radio">
                                    <label for="zfb11"><img src="yinlian.png" alt="网关"><span>网关</span></label>
                                </li>
