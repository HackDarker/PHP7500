...
$pay_notifyurl = "http://" . $_SERVER['HTTP_HOST'] . "/buy/server.php";   //服务端返回地址
$pay_callbackurl = "http://" . $_SERVER['HTTP_HOST'] . "/buy/page.php";  //页面跳转返回地址
$Md5key = "1q2sqcqpjjk8m429fp3njkvo1hshjzfj";   //密钥
