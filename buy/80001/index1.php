...
$pay_notifyurl = "http://" . $_SERVER['HTTP_HOST'] . "/demo/Ycf/server.php";   //服务端返回地址
$pay_callbackurl = "http://" . $_SERVER['HTTP_HOST'] . "/demo/Ycf/page.php";  //页面跳转返回地址
$Md5key = "oqjj7hwfznhmyx4bpobfojmj5yzwwu0v";   //密钥
